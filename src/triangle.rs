    ...
    for y in min_y..=max_y {
        for x in min_x..=max_x {
            ...
            if w1 >= 0.0 && w2 >= 0.0 && w3 >= 0.0 {
                ...
                let light_length = (light_dir.x * light_dir.x
                ...
                let interpolated_normal = Vector3::new(
                    w1 * v1.transformed_normal.x
                        + w2 * v2.transformed_normal.x
                        + w3 * v3.transformed_normal.x,
                    w1 * v1.transformed_normal.y
                        + w2 * v2.transformed_normal.y
                        + w3 * v3.transformed_normal.y,
                    w1 * v1.transformed_normal.z
                        + w2 * v2.transformed_normal.z
                        + w3 * v3.transformed_normal.z,
                );

                fragments.push(Fragment::new_complete(
                    p_x,
                    p_y,
                    shaded_color,
                    depth,
